...
**It is not a shortcut past the checks.** The candidate is validated by `validate_v6` against
...
Intended for the end of the day: the metrics Analysis and its Data, and the summary Report
