"""Shared NDEx transport for the Symposium hackathon tooling.

Canonical JSON in, CX2 on the wire. Nothing here interprets the specification — it moves
artifacts to and from symposium.ndexbio.org and does nothing else. Both the member-side
...
BASE = os.environ.get("SYMPOSIUM_BASE", "https://symposium.ndexbio.org").rstrip("/")
...
def to_cx2(canonical, marks=None):
    ...
    Two modes are anticipated (see CANONICAL-v6.md §7). This is PROJECTION mode: the
