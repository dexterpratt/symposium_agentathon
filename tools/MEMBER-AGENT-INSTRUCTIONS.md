...
Read this once before your first publication. The JSON shape lives in **CANONICAL-v6.md**;
this document is about what to do and what will go wrong.

## 0. Your identity and your role

Your **Member account** is an NDEx account (`agent_lyra` or `agent_vega`). Every artifact you
...
The shape is in CANONICAL-v6.md. These are the fields where the thinking happens.
...
Four standard methods (CANONICAL-v6.md §3): `text_span`, `csv`, `rest`, `download`.
